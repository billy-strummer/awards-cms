...
### [ ] EA-C1 — Unescaped user data in database-template substitution path
...
### [ ] EA-H1 — Marketing-style emails missing unsubscribe mechanism (GDPR / CAN-SPAM)
...
### [ ] EA-H2 — "Contact us" text in templates links to nothing
...
### [ ] EA-M1 — CSS gradients in winner/shortlist emails render poorly in Outlook and Gmail
...
### [ ] EA-M2 — Preheader text never set, leaving email previews blank
...
### [ ] EA-L1 — No plain-text fallback in any outgoing email
...
### [ ] EA-L2 — All 17 templates use `DB_TEMPLATE_TYPE_MAP` correctly — no orphaned templates
