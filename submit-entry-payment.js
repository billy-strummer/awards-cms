/* ==================================================== */
/* ENTRY SUBMISSION FORM WITH STRIPE PAYMENT            */
/* Duplicate of submit-entry.js with payment step added */
/* ==================================================== */
(function () {
  'use strict';
  ...
  window.entryFormApp = {
    ...
    stepLabels: ['Region', 'Sector', 'Category', 'Company', 'About', 'Extra', 'Contact', 'Pay'],
    ...
    // --------------------------------------------------
    // Submit entry then redirect to Stripe Checkout
    // --------------------------------------------------
    async submitEntry() {
      const submitBtn = document.getElementById('submitBtn');
      ...
      try {
        ...
        submitBtn.innerHTML = '<span class="spinner-border spinner-border-sm me-2"></span>Saving entry...';

        // 1. Submit entry via server-side proxy
