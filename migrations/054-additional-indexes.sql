...
-- public_votes: rate-limit queries filter on voted_at and voter_ip
CREATE INDEX IF NOT EXISTS idx_public_votes_voted_at ON public_votes(voted_at);
...
CREATE INDEX IF NOT EXISTS idx_award_years_active_deadline
  ON award_years(is_active, judging_end_date);
