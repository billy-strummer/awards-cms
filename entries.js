        ...
        <div class="modal-dialog modal-xl modal-dialog-scrollable">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <!-- Judge Scores -->
              ${entry.judge_scores && entry.judge_scores.length > 0 ? `
                <div class="card mb-4">
                  <div class="card-header">
                    <h6 class="mb-0"><i class="bi bi-star me-2"></i>Judge Scores (${entry.judge_scores.length})</h6>
                  </div>
                  <div class="card-body">
                    ${entry.judge_scores.map(score => `
                      <div class="card mb-3">
                        <div class="card-body">
                          <div class="d-flex justify-content-between align-items-start mb-3">
                            <div>
                              <strong>${score.judge_name || score.judge_email}</strong>
                              <br>
                              <small class="text-muted">${score.scored_at ? new Date(score.scored_at).toLocaleDateString() : 'N/A'}</small>
                            </div>
                            <div class="text-end">
                              <h4 class="mb-0">${score.total_score || 0}</h4>
                              <small class="text-muted">out of 40</small>
                            </div>
                          </div>

                          <div class="row g-2 mb-3">
                            ${score.innovation_score !== null ? `
                              <div class="col-6 col-md-3">
                                <small class="text-muted d-block">Innovation</small>
                                <strong>${score.innovation_score}/10</strong>
                              </div>
                            ` : ''}
                            ${score.impact_score !== null ? `
                              <div class="col-6 col-md-3">
                            ...
                            ${score.quality_score !== null ? `
                              <div class="col-6 col-md-3">
                                ...
                                <strong>${score.quality_score}/10</strong>
                              </div>
                            ` : ''}
                            ${score.presentation_score !== null ? `
                              <div class="col-6 col-md-3">
                                <small class="text-muted d-block">Presentation</small>
                                <strong>${score.presentation_score}/10</strong>
                              </div>
                            ` : ''}
                          </div>
                          ...
                          ${score.recommendation ? `
                            <div class="mb-2">
                              ...
                              ${score.recommendation === 'shortlist' ? '<span class="badge bg-success">Shortlist</span>' : ''}
                              ${score.recommendation === 'maybe' ? '<span class="badge bg-warning">Maybe</span>' : ''}
                              ${score.recommendation === 'reject' ? '<span class="badge bg-danger">Reject</span>' : ''}
                            </div>
                          ` : ''}
                          ...
                          ${score.strengths ? `
                            <div class="mb-2">
                              ...
                              <p class="mb-0 small">${score.strengths}</p>
                            </div>
                          ` : ''}
                          ...
                          ${score.weaknesses ? `
                            <div class="mb-2">
                              ...
                              <p class="mb-0 small">${score.weaknesses}</p>
                            </div>
                          ` : ''}
