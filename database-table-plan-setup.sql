-- ============================================
-- TABLE PLAN SYSTEM FOR EVENTS
-- ============================================
-- Manages table layouts and seating assignments for events
-- ============================================
...
SELECT
  'Table Plan System Installed!' as message,
  'Tables: event_tables, table_assignments' as tables_created,
  'Functions: get_available_seats, get_unassigned_guests, get_next_table_number' as functions_created,
  'View: table_plan_summary' as views_created;
